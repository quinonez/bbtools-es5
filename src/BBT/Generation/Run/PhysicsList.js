...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function PhysicsList( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  PhysicsList.Shoot = function( args ){
  ...
  PhysicsList.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( PhysicsList.Shoot( argsShoot ) );
    }
  };

  PhysicsList.prototype = {
    constructor: PhysicsList,
