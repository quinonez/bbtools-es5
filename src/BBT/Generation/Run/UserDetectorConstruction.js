...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function UserDetectorConstruction( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  UserDetectorConstruction.Shoot = function( args ){
  ...
  UserDetectorConstruction.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( UserDetectorConstruction.Shoot( argsShoot ) );
    }
  };

  UserDetectorConstruction.prototype = {
    constructor: UserDetectorConstruction,
  ...
  return UserDetectorConstruction;
