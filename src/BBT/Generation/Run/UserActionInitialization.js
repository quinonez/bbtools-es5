...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function UserActionInitialization( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  UserActionInitialization.Shoot = function( args ){
  ...
  UserActionInitialization.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( UserActionInitialization.Shoot( argsShoot ) );
    }
  };

  UserActionInitialization.prototype = {
    constructor: UserActionInitialization,
