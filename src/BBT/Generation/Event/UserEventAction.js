...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function UserEventAction( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  UserEventAction.Shoot = function( args ){
  ...
  UserEventAction.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( UserEventAction.Shoot( argsShoot ) );
    }
  };

  UserEventAction.prototype = {
    constructor: UserEventAction,
