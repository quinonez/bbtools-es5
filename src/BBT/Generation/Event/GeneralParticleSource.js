...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function GeneralParticleSource( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  GeneralParticleSource.Shoot = function( args ){
  ...
  GeneralParticleSource.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( GeneralParticleSource.Shoot( argsShoot ) );
    }
  };

  GeneralParticleSource.prototype = {
    constructor: GeneralParticleSource,
