...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function EvManMessenger( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  EvManMessenger.Shoot = function( args ){
  ...
  EvManMessenger.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( EvManMessenger.Shoot( argsShoot ) );
    }
  };

  EvManMessenger.prototype = {
    constructor: EvManMessenger,
