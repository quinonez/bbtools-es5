...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function StackingMessenger( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  StackingMessenger.Shoot = function( args ){
  ...
  StackingMessenger.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( StackingMessenger.Shoot( argsShoot ) );
    }
  };

  StackingMessenger.prototype = {
    constructor: StackingMessenger,
