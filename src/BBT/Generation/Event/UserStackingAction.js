...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function UserStackingAction( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  UserStackingAction.Shoot = function( args ){
  ...
  UserStackingAction.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( UserStackingAction.Shoot( argsShoot ) );
    }
  };

  UserStackingAction.prototype = {
    constructor: UserStackingAction,
