...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function SPSRandomGenerator( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  SPSRandomGenerator.Shoot = function( args ){
  ...
  SPSRandomGenerator.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( SPSRandomGenerator.Shoot( argsShoot ) );
    }
  };

  SPSRandomGenerator.prototype = {
    constructor: SPSRandomGenerator,
