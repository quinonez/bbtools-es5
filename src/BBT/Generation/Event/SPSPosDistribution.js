...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function SPSPosDistribution( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  SPSPosDistribution.Shoot = function( args ){
  ...
  SPSPosDistribution.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( SPSPosDistribution.Shoot( argsShoot ) );
    }
  };

  SPSPosDistribution.prototype = {
    constructor: SPSPosDistribution,
