...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function StackTrack( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  StackTrack.Shoot = function( args ){
  ...
  StackTrack.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( StackTrack.Shoot( argsShoot ) );
    }
  };

  StackTrack.prototype = {
    constructor: StackTrack,
