...
define([ '../Random/JamesRandom' ], function( JamesRandom ){
  ...
  function TrajectoryContainer( args ){
    this.fengine = args.engine || new JamesRandom({});
  } 

  TrajectoryContainer.Shoot = function( args ){
  ...
  TrajectoryContainer.ShootArray = function( args ){
    ...
    for( var i = 0; i < ssize; ++i ){
      args.vect.push( TrajectoryContainer.Shoot( argsShoot ) );
    }
  };

  TrajectoryContainer.prototype = {
    constructor: TrajectoryContainer,
